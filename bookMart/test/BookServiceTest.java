...
public class BookServiceTest {
	...
	public static void main(String[] args) {
		...
		BookService bs = new KJBookService(new ListBookDAO());
		
		// 책 등록
		bs.registBook(new BookVO("test", "gyejeong", "kopo", 10000, 10));
...
BookDAO bookDAO = new ListBookDAO();
		...
		// 책 등록
		bookDAO.insertBook(new BookVO("test", "gyejeong", "kopo", 10000, 10));
